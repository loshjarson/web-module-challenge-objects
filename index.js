...
function createMenuItem(item_name, item_price, item_category) {
  let menu_item = {
    name: item_name,
    price: item_price,
...
*/
let sprite = createMenuItem("sprite", 1, "drinks");
let salad = createMenuItem("salad", 5, "sides")
let pancake = createMenuItem("pancake", 2, "breakfast")
console.log(sprite, salad, pancake);
...
function getReviewByIndex(array, index) {
  ...
  console.log(spec_review);
  let name = spec_review.name
  let rating = spec_review.rating
  let feedback = spec_review.feedback
...
function getLastReview(array) {
  ...
  return `${array[last_index].name} gave the restaurant a ${array[last_index].rating} star review, and their feedback was: ${array[last_index].feedback}`;
}
